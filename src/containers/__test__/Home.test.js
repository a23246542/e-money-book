...
import { parseToYearsAndMonth, flattenArr, LIST_VIEW, CHART_VIEW } from '../../utility'
...
describe('test home container with loaded data', () => {
  ...
  it('click the the tab should change the view and state', () => {
    ...
    expect(wrapper.find('.nav-tabs .nav-link').at(1).hasClass('active')).toEqual(true);//如果是Tabs自己有寫測試了
  })
})
